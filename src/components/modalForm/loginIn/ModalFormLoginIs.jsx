    ...
    return (
        <>
            <button
                ref={btnOpen}
                type={'button'}
                class={'flex-shrink-0 bg-blue-600 hover:bg-blue-700 border-blue-600 hover:border-blue-700 text-sm border-4 text-white py-1 px-10 rounded'}>
                Sign in
            </button>
        <Dismiss
            menuButton={btnOpen}
        ...
        >
            <div class="absolute shadow-2xl right-40 mt-4 z-50 p-6 rounded-lg bg-white max-w-sm">
                <form>
