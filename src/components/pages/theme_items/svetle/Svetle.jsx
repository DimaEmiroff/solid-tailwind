...
const theme = {
    ...
    images: [
        {
            src: 'https://www.admin-dashboards.com/content/images/2021/04/svelte-notus-free-template-cover.png',
            alt: 'admin-dashboards',
        },
        {
            src: 'https://s3.amazonaws.com/creativetim_bucket/products/395/original/opt_notus_svelte_thumbnail.jpg?1602083070',
            alt: 'maxresdefault',
        },
        {
            src: 'https://avatars.mds.yandex.net/i?id=6f3e994aa66ff77c3b8bfe78f919d8be-4432110-images-thumbs&ref=rim&n=33&w=340&h=225',
            alt: 'Model lending page',
        },
        {
            src: 'https://mir-cdn.behance.net/v1/rendition/project_modules/2800/106d2782451849.5d1dc251b9f74.png',
            alt: 'Model Svetle+Tailwind',
        },
    ],
}
