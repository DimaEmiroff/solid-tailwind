...
const theme = {
    ...
    images: [
        {
            src: 'https://i.pinimg.com/originals/f9/6f/1c/f96f1ca74a287cce50c1017e949f1769.png',
            alt: 'admin-dashboards',
        },
        {
            src: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/bdd48d91990141.5e403dfeabdf7.jpg',
            alt: 'maxresdefault',
        },
        {
        ...
        {
            src: 'https://i.ytimg.com/vi/bhoDwo24K5Q/maxresdefault.jpg?9289889566',
    ...
    return (
        <div class="mb-40">
            ...
            <div class="mt-6 max-w-2xl mx-auto rounded-3 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
                <div class="aspect-w-6 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-3 lg:aspect-h-4">
                    <img
