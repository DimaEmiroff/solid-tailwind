...
const Navigation = () => {
    return (
        <div className="flex items-baseline space-x-4 bg-slate-500">
            <div className="w-full flex items-baseline space-x-4 bg-slate-500">
                {navigation.map((item) => (
                    <a
                        key={item.name}
                        href={item.href}
            ...
            <div className="flex justify-center ">
                <div className=" xl:w-66 mr-2">
                    <div className="input-group relative flex items-stretch">
                        <input type="search"
                               className="form-control relative flex-auto min-w-0 block w-48 px-3 py-1 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
